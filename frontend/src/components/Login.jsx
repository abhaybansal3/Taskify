    ...
    <div className="min-h-screen flex" style={{ backgroundColor: '#FFFAE9' }}>
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden flex-col justify-between"
        ...
        <div className="relative z-10 flex items-center" style={{ gap: '-8px' }}>
          ...
          <span style={{ color: 'rgba(255,255,255,0.5)', fontSize: '14px', marginLeft: '12px' }}>10,000+ happy users</span>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center" style={{ padding: '40px 24px' }}>
        <div style={{ width: '100%', maxWidth: '440px' }}>
          ...
          <h1 style={{ color: '#0D0B21', fontSize: '32px', fontWeight: 800, marginBottom: '8px' }}>Log in</h1>
          <p style={{ color: '#636071', fontSize: '16px', marginBottom: '32px' }}>
            Don&rsquo;t have an account? <Link to="/signup" style={{ color: '#4318FF', fontWeight: 600, textDecoration: 'none' }}>Sign up</Link>
          </p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex justify-between items-center" style={{ marginBottom: '28px' }}>
              <label className="flex items-center" style={{ gap: '8px', cursor: 'pointer' }}>
                <input type="checkbox" style={{ width: '16px', height: '16px', accentColor: '#4318FF' }} />
                <span style={{ color: '#636071', fontSize: '14px' }}>Remember me</span>
              </label>
              <a href="#" style={{ color: '#4318FF', fontSize: '14px', fontWeight: 600, textDecoration: 'none' }}>Forgot password?</a>
            </div>
